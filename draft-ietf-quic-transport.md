...
The server receives this packet and determines that it potentially creates a new
connection.  It then checks whether it understands the version that the client
has selected.
